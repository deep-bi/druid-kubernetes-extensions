...
public class K8sDiscoveryConfig {
    ...
    public K8sDiscoveryConfig(
            ...
            @JsonProperty("coordinatorLeaderElectionConfigMapNamespace")
        ...
        Preconditions.checkArgument(
                clusterIdentifier != null && !clusterIdentifier.isEmpty(), "null/empty clusterIdentifier");
        Preconditions.checkArgument(
        ...
        if (coordinatorLeaderElectionConfigMapNamespace == null) {
            LOGGER.warn(
                    "IF coordinator pods run in multiple namespaces, then you MUST provide coordinatorLeaderElectionConfigMapNamespace");
        }
        ...
        if (overlordLeaderElectionConfigMapNamespace == null) {
            LOGGER.warn(
                    "IF overlord pods run in multiple namespaces, then you MUST provide overlordLeaderElectionConfigMapNamespace");
        }
    ...
    public String toString() {
        return "K8sDiscoveryConfig{" + "clusterIdentifier='"
                + clusterIdentifier + '\'' + ", podNameEnvKey='"
                + podNameEnvKey + '\'' + ", podNamespaceEnvKey='"
                + podNamespaceEnvKey + '\'' + ", coordinatorLeaderElectionConfigMapNamespace='"
                + coordinatorLeaderElectionConfigMapNamespace + '\'' + ", overlordLeaderElectionConfigMapNamespace='"
                + overlordLeaderElectionConfigMapNamespace + '\'' + ", leaseDuration="
    ...
    public boolean equals(Object o) {
        ...
        return clusterIdentifier.equals(that.clusterIdentifier)
                ...
                && Objects.equals(
                        coordinatorLeaderElectionConfigMapNamespace, that.coordinatorLeaderElectionConfigMapNamespace)
                && Objects.equals(
                        overlordLeaderElectionConfigMapNamespace, that.overlordLeaderElectionConfigMapNamespace)
