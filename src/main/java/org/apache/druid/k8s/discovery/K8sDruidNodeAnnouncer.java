...
public class K8sDruidNodeAnnouncer implements DruidNodeAnnouncer {
    ...
    public void announce(DiscoveryDruidNode discoveryDruidNode) {
        ...
        try {
            ...
            patches.add(createPatchObj(
                    OP_ADD,
                    getPodDefLabelPath(idAnnouncementLabel),
                    hashEncodeStringForLabelValue(
    ...
    public static String getLabelSelectorForNode(
            K8sDiscoveryConfig discoveryConfig, NodeRole nodeRole, DruidNode node) {
        return StringUtils.format(
                "%s=%s,%s=%s,%s=%s",
                getClusterIdentifierAnnouncementLabel(),
                discoveryConfig.getClusterIdentifier(),
