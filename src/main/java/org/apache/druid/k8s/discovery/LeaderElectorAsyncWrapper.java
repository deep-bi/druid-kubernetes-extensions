...
public class LeaderElectorAsyncWrapper implements Closeable {
    ...
    public LeaderElectorAsyncWrapper(
        ...
        Preconditions.checkArgument(
                K8sDiscoveryConfig.K8S_RESOURCE_NAME_REGEX
                        .matcher(lockResourceName)
                        .matches(),
        ...
        LOGGER.info(
                ...
                candidateId, lockResourceName, lockResourceNamespace);
    ...
    public void close() {
        ...
        try {
            ...
            if (!executor.awaitTermination(10, TimeUnit.SECONDS)) {
                LOGGER.warn(
                        "Failed to terminate [%s] executor.", this.getClass().getSimpleName());
            }
